	...
	render() {
		...
		if (compareTo !== undefined) {
			content = (<CompareTable
				...
				imagePerSeconde={this.state.imagePerSeconde}
				...
				<header className="header-container">
					...
					<form>
						<input type="number"
							...
							defaultValue={this.state.imagePerSeconde.toString()} />
						...
						<select name="source" id="source" value={this.state.source} onChange={this.onSource}>
